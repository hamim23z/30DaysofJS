...
//Number One//
for (let {name, capital, languages, population} of countries1){
    console.log(name, capital, languages, population)
}

//Number Two//
let student = ['David', ['HTML', 'JS', 'CSS', 'REACT'], [98, 85, 90, 95]]
let [hisname, skills, [,,jsScore, reactScore]] = student
console.log(hisname, skills, jsScore, reactScore)
